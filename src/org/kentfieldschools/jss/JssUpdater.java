...
public class JssUpdater {
	...
	private void readProperties() throws IOException {
		...
		if (inputStream != null) {
			...
			if (jssServerUrl == null || authUsername == null || authPassword == null) {
	...
	public MobileDeviceMatch findMobileDevice(String serialNumber) {
		...
		String matchUrlString = jssServerUrl + MOBILE_DEVICES_API_PATH + "/match/"
				+ serialNumber;
	...
	public void processCsvFile(String csvFile) throws IOException {
		...
		for (CSVRecord record : parser) {
			...
			if (serialNumber != null && !serialNumber.isEmpty() 
				...
				boolean success = updateMobileDevice(serialNumber, deviceName, assetTag);
				System.out.println("update " + serialNumber + ", " + String.valueOf(success));
			} else {
